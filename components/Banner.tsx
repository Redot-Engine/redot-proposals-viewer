...
export default function Banner({ mainMessage, subMessage, link }: Readonly<BannerProps>) {
  ...
  return (
    <Link href={link} target="_blank" rel="noopener noreferrer">
      <div className="group flex select-none items-center justify-center gap-2 bg-linear-to-r from-pink-500 via-amber-500 to-orange-500 py-2 font-sans text-sm font-medium tracking-tight text-white">
